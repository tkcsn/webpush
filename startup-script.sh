...
WEBPUSH_DEPLOY_LOCATION=$(curl -s "http://metadata.google.internal/computeMetadata/v1/instance/attributes/app-location" -H "Metadata-Flavor: Google")
...
gsutil cp $WEBPUSH_DEPLOY_LOCATION /app.tar
mkdir -p /app
